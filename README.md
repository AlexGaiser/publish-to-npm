...
5. [`module`]
6. `types`: If you have followed this guide and set up your project as a `Typescript` project, you will need to point to the source of your type definitions so that JS and TS environments can read them. In our example it will point to `dist/index.d.ts`.
